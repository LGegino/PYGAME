...
def investigate():
    tools.txt_list = [
        ...
        f"It drpos down with a spine chilling shriek... and you feint.{tools.TextColor.RESET}"
    ]
    tools.slow_print_list(tools.txt_list)
...
def ignore():
    tools.txt_list = [
        ...
        "However, you noticed something is off and an eerie sensation clouds your mind- thinking that you are being followed.",
        "You slowly turned around and saw a man with missing eyes and a broken hanging jaw... With slowly decaying skin infested with maggots.",
        f"His hands spring towards your neck and clenches it- strangling you. You tried to gasp for air... then moments later, you feint.{tools.TextColor.RESET}"
    ]
    tools.slow_print_list(tools.txt_list)
